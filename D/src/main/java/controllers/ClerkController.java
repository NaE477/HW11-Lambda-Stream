...
public class ClerkController {
            ...
            while (true) {
                ...
                switch (opt) {
                    ...
                    case "2":
                        ...
                        break;
                    case "0":
                        Integer editID = clerkService.editProfile(clerk);
                        if (editID != null) System.out.println("Clerk updated with ID: " + editID);
    ...
    private void deleteClerk() {
        ...
        if(clerkToDelete != null){
            Integer deleteID = clerkService.deleteClerk(clerkToDelete);
            if (deleteID != null) System.out.println("Clerk deleted with ID: " + deleteID);
            else System.out.println("Something went wrong with database.");
        } else System.out.println("Wrong ID");
    }
